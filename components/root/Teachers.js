export const Teacher = ({image, name, designation,}) => (
    ...
    return (
      <section className="section why-us" data-section="section5">
        <div className="container">
          ...
          <div className="row">
            <Teacher image="/images/team-1.jpg" name="Dr. Mark " designation="Mathematiques"/>
            <Teacher image="/images/team-4.jpg" name="Mr. Technogadget" designation="Chess"/>
            <Teacher image="/images/team-3.jpg" name="Ms. Wiz" designation="UI Design"/>
